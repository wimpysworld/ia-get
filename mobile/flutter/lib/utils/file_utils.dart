...
class FileUtils {
  ...
  static String formatEstimatedTime(double progress, double bytesPerSecond, int totalBytes) {
  ...
  static Future<String> getUniqueFilename(String basePath, String filename) async {
